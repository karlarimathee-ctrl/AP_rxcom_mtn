...
export default function Login() {
    ...
    // ─── LOGIN SIMPLE (2FA désactivée temporairement) ────────────────────────
        ...
        try {
            ...
            try {
                ...
                if (fetchErr?.name === "AbortError") {
                    ...
                    setErrorMsg(`Impossible de contacter le serveur . Vérifiez votre réseau ou l'URL du serveur.`);
                }
                triggerShake();
                return;
            } finally {
            ...
            // On sauvegarde l'utilisateur + l'horodatage de connexion (pour la session 1 mois)
